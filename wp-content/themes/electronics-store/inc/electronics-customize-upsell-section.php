 ...
 */
/**
 * Class Electronics_Store_Customizer_Upsell_Section
 */
class Electronics_Store_Customizer_Upsell_Section extends WP_Customize_Section {
	/**
	...
	/**
	 * Electronics_Store_Customizer_Upsell_Section constructor.
	 */
	public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
		$manager->register_section_type( 'Electronics_Store_Customizer_Upsell_Section' );
