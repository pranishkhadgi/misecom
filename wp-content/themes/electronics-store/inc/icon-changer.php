...
class Electronics_Store_Icon_Changer extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                        <div class="social-icon-search">
                              <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'electronics-store'); ?>">
                        </div>
                        <?php
                        $electronics_store_font_awesome_icon_array = electronics_store_font_awesome_icon_array();
                        foreach ($electronics_store_font_awesome_icon_array as $electronics_store_font_awesome_icon) {
                              $icon_class = $this->value() == $electronics_store_font_awesome_icon ? 'icon-active' : '';
                              echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($electronics_store_font_awesome_icon).'"></i>
                                    <span class="icons-class">'.esc_attr($electronics_store_font_awesome_icon).'</span>
                              </li>';
                        }
                        ?>
                  </ul>
...
function electronics_store_customizer_script() {
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'electronics_store_customizer_script' );

if(!function_exists('electronics_store_font_awesome_icon_array')){
    function electronics_store_font_awesome_icon_array(){
        return array("None", 
            "fab fa-500px",
