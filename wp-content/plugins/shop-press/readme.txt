...
If you’re looking for a WooCommerce Addons plugin for Elementor Page Builder or a unique WooCommerce builder to make your online store stand out, we’ve got you covered.
...
🎙️ [Introduction](https://climaxthemes.com/shoppress/)
💻 [Demo](https://climaxthemes.com/shoppress/demo/)
📃 [Documentation](https://climaxthemes.com/shoppress/helpdesk/)
...
== ✨ Single Builder ==
With about 20 ShopPress widgets for the single product page, create your own website single product page and have control over all the details. With this amazing Elementor WooCommerce builder you don’t need to limit yourself to the default WooCommerce layout.
...
= 1.4.8 - 3 September 2024 =
Added: Brand attribute for variation swatches
Added: New gallery type for product gallery (Pro)
Fixed: Display attribute image on change variation
Fixed: Woo filters

= 1.4.7 - 20 August 2024 =
Added: Carousel and heading options for recently viewed products widget
Fixed: Woo my account lost password issues
Fixed: Product loop builder status
Fixed: Modern quantity styling issue
