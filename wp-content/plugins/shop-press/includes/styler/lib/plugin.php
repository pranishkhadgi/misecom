...
final class Plugin {
	...
	private static function hooks() {
		...
		add_action( 'admin_enqueue_scripts', array( __CLASS__, 'script_translations_admin' ) );
		add_action( 'wp_enqueue_scripts', array( __CLASS__, 'script_translations' ) );
	...
	*/
	...
	public static function load_textdomain() {
		load_plugin_textdomain( 'styler', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
	}
	 ...
	 * @since 1.0.0
	 */
	public static function script_translations_admin() {
		wp_set_script_translations( 'styler-admin', 'styler', STYLER_PATH . 'languages' );
	}
	 ...
	 * @since 1.0.0
	 */
	public static function script_translations() {
		wp_set_script_translations( 'styler', 'styler', STYLER_PATH . 'languages' );
	}
}
